        ...
        if (dates.length > 1) {
            ...
            shiftsToProcess.forEach((shift)=>{
                const shiftLogs = shiftsToProcess.length === 1 && shift.shift_name === "ALL DAY" ? logs : logs.filter((l)=>{
                    const roundTime = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$reports$2f$roundtime$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUND_TIMES"][l.round];
...
//# sourceMappingURL=app_components_reports_d646b0f8._.js.map