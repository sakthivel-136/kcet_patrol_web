...
function ReportDownloadPage() {
    ...
    const fetchReport = async ()=>{
        ...
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$report$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPatrolReport"])(FIXED_CAMPUS, start, end);
            setReport(data);
...
_s(ReportDownloadPage, "c1etBWuphBg/X2QEK9v/sjvMysQ=", false, function() {
    return [
...
//# sourceMappingURL=app_b2cf695a._.js.map